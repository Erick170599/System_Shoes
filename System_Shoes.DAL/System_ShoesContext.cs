...
namespace System_Shoes.DAL
{
    public class SystemShoesContext : DbContext
    {
        public static string conString = "Server=.;Database=systemshdb;Trusted_Connection=true;";
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Cliente>(
                C =>
                {
                    ...
                    C.Property(c => c.descuento).HasColumnType("decimal(8,2)").IsRequired();
                    C.Property(c => c.activo).HasDefaultValue(true).IsRequired();
                });
