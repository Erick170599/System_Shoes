    ...
    public partial class frmNVenta : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void gcVentaDetalle_EmbeddedNavigator_ButtonClick(object sender, NavigatorButtonClickEventArgs e)
        {
            if (e.Button.ButtonType == NavigatorButtonType.Remove)
                if (XtraMessageBox.Show("¿Desea eliminar el reglón?", Application.ProductName, MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question) != DialogResult.Yes) e.Handled = true;
        }
        ...
        private void lupCliente_Popup(object sender, EventArgs e)
        {
